...
<body>
  ...
  <!-- End of notification pop up -->
    ...
    <div class="content course-container-margin">
      <div class="main-screen">
        <div class="categories-container mobile-category-container">
            <div class="search">
            ...
            <div class="categories-sub-text">
                <p>Browse through our extensive catalog, teeming with courses spanning across various domains and access your gateway to a universe of knowledge and skill development!</p>
            </div>
            <div class="mobile-search">
              <input type="search" id="mobilesearchInput" placeholder="Search for your preferred course">
              <img src="img/svg/search-icon.svg" alt="">
              <!-- search items -->
              <ul id="mobileitemList">
                <li class="hidden"><a href="courses/microsoft-office-tools.html"><img src="img/ms office course.png" alt=""> Microsoft Office Suite</a></li>
                <li class="hidden"><a href="courses/google-suite-tools.html"><img src="img/G-Suite.png" alt=""> Google Suite</a></li>
                <li class="hidden"><a href="courses/canva-for-educators.html"><img src="img/Canva for Educators Image.png" alt=""> Canvas for Educators</a></li>
                <li class="hidden"><a href="courses/kahoot-for-educators.html"><img src="img/Kahoot for Educators Image.png" alt=""> Kahoot for Educators</a></li>
          ...
          <div class="laptop-courses-container">
            <a href="courses-for-educators.html" class="courses-for-educators-container" style="text-decoration: none;">
                <p class="category-title">Courses for Educators</p>
                <p class="course-desc">Inspire, engage, and empower your students with our comprehensive library of professional development courses for educators.
                </p>
            </a>
            <div class="available-courses">
                <div class="course-box">
                  <a href="courses-for-educators.html"><img src="img/Microsoft Office Suite Image.png" alt=""></a>
                  <div class="box-title">
                    <a href="courses-for-educators.html">Microsoft Office Suite</a>
                  </div>
                </div>
                <div class="course-box">
                  <a href="courses-for-educators.html"><img src="img/Google Suite Image.png" alt=""></a>
                  <div class="box-title">
                    <a href="courses-for-educators.html">Google Suite</a>
                  </div>
                </div>
                <div class="course-box">
                  <a href="courses-for-educators.html"><img src="img/Canva for Educators Image.png" alt=""></a>
                  <div class="box-title">
                    <a href="courses-for-educators.html">Canva for Educators</a>
                  </div>
                </div>
            </div>
            <div class="tech-courses-container mobile-tech-courses" style="margin-top: -155px; width: 100%;">
                <div class="tech-courses-header">
                  <div class="tech-courses">Tech Courses</div>
                </div>
                <div class="tech-courses-body">
                  <div class="coming-soon">
                    <div class="coming-soon2">COMING SOON</div>
                  </div>
                </div>
            </div>
            <div class="tech-courses-container social" style="width: 100%;">
                <div class="tech-courses-header">
                  <div class="tech-courses">Social Media Courses</div>
                </div>
                <div class="tech-courses-body">
                  <div class="coming-soon">
                    <div class="coming-soon2">COMING SOON</div>
          ...
          <div class="mobile-courses-container">
            <div class="mobile-courses-description">
              <div class="course-title">Courses for Educators</div>
              <div class="sub-title">Inspire, engage, and empower your students with our comprehensive library of professional development courses for educators.
                <ul>
            ...
            <div class="mobile-courses-box">
              ...
              <div class="mobile-box">
                <a href="courses-for-educators.html"><img src="img/Kahoot for Educators Image.png" alt=""></a>
                <div class="mobile-course-name">
                  <p>Kahoot for Educators</p>
                </div>
              </div>
              <div class="mobile-box">
                <a href="courses-for-educators.html"><img src="img/Microsoft Innovative Educator Programme Image.png" alt=""></a>
                <div class="mobile-course-name">
                  <p>Microsoft Innovative Educator Programme</p>
                </div>
              </div>
              <div class="mobile-box">
                <a href="courses-for-educators.html"><img src="img/social.png" alt=""></a>
                <div class="mobile-course-name">
                  <p>Social Media Tools for Educators</p>
                </div>
              </div>
              <div class="mobile-box">
                <a href="courses-for-educators.html"><img src="img/ai-tools.png" alt=""></a>
                <div class="mobile-course-name">
                  <p>AI Tools for Educators</p>
                </div>
              </div>
              <div class="mobile-box">
                <a href="courses-for-educators.html"><img src="img/virtual-learning.png" alt=""></a>
                <div class="mobile-course-name">
                  <p>Virtual Learning Platforms</p>
                </div>
              </div>
            </div>
            <div class="mobile-tech-container">
              <div class="tech-title">Tech Courses</div>
              <div class="tech-content">
                COMING SOON
              </div>
            </div>
            <div class="mobile-tech-container">
              <div class="tech-title">Social Media Courses</div>
              <div class="tech-content">
                COMING SOON
              </div>
            </div>
