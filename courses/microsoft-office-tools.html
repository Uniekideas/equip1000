...
<head>
    ...
    <title>Microsoft Office Tools - EQUIP1000</title>
  ...
  <!-- End of notification pop up -->
    ...
    <div class="content mobile-course-content">
      ...
      <div class="microsoft-container">
        ...
        <div class="microsoft-office-suite-description">
          <p><span class="one">Conquer Your Workflow with Microsoft Office Suite:
          <br /></span>
          <span class="two">A Productivity Powerhouse
          <br /></span>
          <span class="three">Microsoft Office Suite has been a household name for decades, and for good reason. It's an all-in-one powerhouse of tools designed to boost your productivity and creativity in every aspect of your work or studies.
          </span></p>
        </div>
        <div class="microsoft-office-suite-image">
          <img src="../img/ms office course.png" alt="ms office"/>
        </div>
        <div class="course-description">
          <p class="desc">In this immersive course, we will take you through what we call The Essential Trio: Word, Excel, and PowerPoint; with an addition of Microsoft forms.</p>
          <p class="desc">By the end of this course you will be a Professional with the Suite.
          </p>
          <p class="course-duration">Course Duration: 134 Hrs</p>
        </div>
        ...
        <div class="listed-courses top-course">
          <p class="course-header">Microsoft Word</p>
          <p class="course-short-description">Craft stunning documents, from simple letters to complex reports, with ease</p>
          <div class="course-image">
            <img src="../img/ms-word.png" alt="ms word" />
          </div>
          <a href="../equip100-courses/microsoft-office-tools/microsoft-word.html">Enroll</a>
        </div>
        <div class="listed-courses">
          <p class="course-header">Microsoft Excel</p>
          <p class="course-short-description">Transform data into actionable insights with powerful formulas, charts, and graphs.</p>
          <div class="course-image">
            <img src="../img/ms-excel.png" alt="ms excel" />
          </div>
          <a href="../equip100-courses/microsoft-office-tools/microsoft-excel.html">Enroll</a>
        </div>
        <div class="listed-courses">
          <p class="course-header">Microsoft PowerPoint</p>
          <p class="course-short-description">Captivate your audience with dynamic presentations that tell your story visually.</p>
          <div class="course-image">
            <img src="../img/ms-powerpoint.png" alt="ms PowerPoint" />
          </div>
          <a href="../equip100-courses/microsoft-office-tools/microsoft-powerpoint.html">Enroll</a>
        </div>     
      </div>
    </div>
    ...
    <div class="right-content r-content">
      <div class="translate-button">
        <a href=""><img src="../img/svg/g_translate.svg" alt="Translate"> TRANSLATE PAGE</a>
      </div>
      <br>
      <div class="translate-button">
        <a href=""><img src="../img/svg/speaker_phone.svg" alt="Translate"> TRANSLATE PAGE</a>
      </div>
