    ...
    <div class="content mobile-course-content">
      ...
      <div class="microsoft-container">
        ...
        <div class="microsoft-office-suite-description">
          <p><span class="one">Ignite Your Teaching Passion:
          <br /></span>
          <span class="two">A Journey of Transformation
          <br /></span>
          <span class="three">Are you an educator who thrives on innovation? Do you dream of transforming classrooms into vibrant hubs of learning and engagement? Then look no further than the Microsoft Innovative Educator (MIE) Programme, a global initiative designed to empower educators like you to become changemakers in education.
          </span></p>
        </div>
        <div class="microsoft-office-suite-image">
          <img style="object-fit: initial;" src="../img/Microsoft Innovative Educator Programme Image.png" alt="ms innovative"/>
        </div>
        <div class="course-description">
          <p class="desc">No matter your experience level, the MIE Programme has something to offer you. Whether you&#039;re a seasoned veteran or a tech-savvy newcomer, you&#039;ll find a supportive community, valuable resources, and endless opportunities for growth</p>
          <p class="course-duration">Course Duration: 113 Hrs</p>
        </div>
        ...
        <div style="margin-top: 30px;" class="listed-courses top-course">
          <a href="../equip100-courses/microsoft-innovative/microsoft-innovative.html">Enroll</a>
        </div>
      </div>
    </div>
    </div>
