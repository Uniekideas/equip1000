...
<head>
    ...
    <title>Canva for Educators - EQUIP1000</title>
    ...
    <div class="content mobile-course-content">
      ...
      <div class="microsoft-container">
        ...
        <div class="microsoft-office-suite-description">
          <p><span class="one">Unleash Your Inner Creative with Canva:
          <br /></span>
          <span class="two">Design Like a Pro, Effortlessly
          <br /></span>
          <span class="three">Canva is not just a design tool, it's a creativity playground. It empowers everyone, from seasoned designers to complete beginners, to bring their ideas to life with stunning visuals.
          </span></p>
        </div>
        <div class="microsoft-office-suite-image">
          <img style="object-fit: initial;" src="../img/Canva for Educators Image-c.png" alt="ms office"/>
        </div>
        <div class="course-description">
          <p class="desc">Unleash Your Inner Designer by diving into Canva's Creative Playground.</p>
          <p class="desc">Ever dreamt of creating stunning visuals but lacked the professional tools or design skills? Well, fret no more! Through this course, you will learn how to harness Canva, your one-stop shop for bringing your creative visions to life, effortlessly and with endless possibilities.
          </p>
          <p class="course-duration">Course Duration: 94 Hrs</p>
        </div>
        ...
        <div style="margin-top: 30px;" class="listed-courses top-course">
          <a href="../equip100-courses/canva/canva.html">Enroll</a>
        </div>
      </div>
    </div>
    </div>
