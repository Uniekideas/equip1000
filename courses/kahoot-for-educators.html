...
<head>
    ...
    <title>Kahoot for Educators - EQUIP1000</title>
    ...
    <div class="content mobile-course-content">
      ...
      <div class="microsoft-container">
        ...
        <div class="microsoft-office-suite-description">
          <p><span class="one">Where Learning Meets Fun:
          <br /></span>
          <span class="two">A Game-Changer for Education
          <br /></span>
          <span class="three">Imagine a classroom erupting in cheers, not groans, as students battle it out in a trivia showdown. That&#039;s the magic of Kahoot, a game-based learning platform that transforms education from a passive lecture into an interactive, adrenaline-pumping adventure.
          </span></p>
        </div>
        <div class="microsoft-office-suite-image">
          <img style="object-fit: initial;" src="../img/Kahoot for Educators Image.png" alt="ms office"/>
        </div>
        <div class="course-description">
          <p class="desc">Turn any topic into a game: From history and science to pop culture and current events, create engaging quizzes that ignite curiosity and spark critical thinking.</p>
          <p class="desc">Embrace friendly competition: Answer multiple-choice questions in real-time, race against classmates on their own devices, and see who reigns supreme on the leaderboard.
          </p>
          <p class="course-duration">Course Duration: 100 Hrs</p>
        </div>
        <div class="course-status">
          <div class="status-color"></div>
          <p>NOT STARTED</p>
        </div>
        <div style="margin-top: 30px;" class="listed-courses top-course">
          <a href="../equip100-courses/hahoot/kahoot.html">Enroll</a>
        </div>
      </div>
    </div>
    </div>
