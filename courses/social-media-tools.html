...
<head>
    ...
    <title>Social Media Tools - EQUIP1000</title>
    ...
    <div class="content mobile-course-content">
      ...
      <div class="microsoft-container">
        ...
        <div class="microsoft-office-suite-description">
          <p><span class="one">Engaging, Educating, and Empowering
          <br /></span>
          </p>
        </div>
        ...
        <div class="course-description">
          <p class="desc">Gone are the days of dusty textbooks and monotonous lectures. Today&#039;s educators have a powerful arsenal at their disposal: social media tools! These platforms can transform learning into an interactive, engaging, and globally connected experience. Let&#039;s explore some amazing tools that educators can leverage</p>
          <p class="course-duration">Course Duration: 84 Hrs</p>
        </div>
        ...
        <div class="listed-courses top-course">
          <p class="course-header">LinkedIn</p>
          <p class="course-short-description">Master LinkedIn: A Comprehensive Tutorial Course to Level Up Your Profile and Network</p>
          <div class="course-image">
            <img src="../img/linkedin.png" alt="linkedin" />
          </div>
          <a href="../equip100-courses/social-media-tool/linkedin.html">Enroll</a>
        </div>
        <div class="listed-courses">
          <p class="course-header">Instagram</p>
          <p class="course-short-description">Unleash Your Insta-Magic: Dive into Our Instagram Tutorial Course!</p>
          <div class="course-image">
            <img src="../img/instagram.png" alt="instagram" />
          </div>
          <a href="../equip100-courses/social-media-tool/instagram.html">Enroll</a>
        </div>
        <div class="listed-courses">
          <p class="course-header">TikTok</p>
          <p class="course-short-description">From Zero to Viral: Your Guide to TikTok Success!</p>
          <div class="course-image">
            <img src="../img/ticktok.png" alt="TikTok" />
          </div>
          <a href="../equip100-courses/social-media-tool/tiktok.html">Enroll</a>
        </div>
        <div class="listed-courses">
            <p class="course-header">YouTube</p>
            <p class="course-short-description">Conquer YouTube with This Ultimate Tutorial Course: From Beginner to Mastermind!</p>
            <div class="course-image">
              <img src="../img/youtube.png" alt="YouTube" />
            </div>
            <a href="../equip100-courses/social-media-tool/youtube.html">Enroll</a>
          </div>  
          <div class="listed-courses">
            <p class="course-header">E-books</p>
            <p class="course-short-description">Unleash Your Inner Author: Dive into the World of Ebooks with this Comprehensive Tutorial Course!</p>
            <div class="course-image">
              <img src="../img/e-book.png" alt="E-books" />
            </div>
            <a href="../equip100-courses/social-media-tool/e-book.html">Enroll</a>
          </div>     
          <div class="listed-courses">
            <p class="course-header">Podcasts</p>
            <p class="course-short-description">Unleash Your Inner Podcaster: Dive into the World of Podcast Creation with this Comprehensive Tutorial</p>
            <div class="course-image">
              <img src="../img/podcasts.png" alt="Podcast" />
            </div>
            <a href="../equip100-courses/social-media-tool/podcasts.html">Enroll</a>
          </div>    
      </div>
    </div>
    </div>
