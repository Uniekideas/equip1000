...
<head>
    ...
    <title>Virtual Learning Platform - EQUIP1000</title>
    ...
    <link rel="stylesheet" href="../js/notofication.js">
</head>
<body>
    ...
    <div class="content mobile-course-content">
      ...
      <div class="microsoft-container">
        ...
        <div class="microsoft-office-suite-description">
          <p><span class="one">Master the Virtual Classroom:
          <br /></span>
          <span class="two"> A Guide to Virtual Learning Platforms Tutorials<br /></span>
          <span class="three">The education landscape is evolving, and virtual learning platforms (VLPs) are at the forefront of this exciting change. Whether you&#039;re a seasoned educator, a curious student, or a corporate trainer, mastering VLPs can unlock a world of possibilities. This is where our comprehensive VLP tutorial course comes in!</span>
          </p>
        </div>
        <div class="microsoft-office-suite-image">
          <img src="../img/virtual-learning.png" alt="AI Tool"/>
        </div>
        <div class="course-description">
          <p class="desc">Imagine engaging students from across the globe, creating interactive learning experiences, and fostering vibrant online communities. VLPs make it all possible. Our course will equip you with the knowledge and skills to confidently navigate the world of virtual learning.</p>
          <p class="course-duration">Course Duration: 53 Hrs</p>
        </div>
        ...
        <div class="listed-courses top-course">
          <p class="course-header">WhatsApp</p>
          <p class="course-short-description">Mastering WhatsApp: From Beginner to Chat Master</p>
          <div class="course-image">
            <img src="../img/whatsapp.png" alt="WhatsApp" />
          </div>
          <a href="../equip100-courses/virtual-learning/whatsapp.html">Enroll</a>
        </div>
        <div class="listed-courses">
          <p class="course-header">Zoom</p>
          <p class="course-short-description">Master the Art of Virtual Connection</p>
          <div class="course-image">
            <img src="../img/zoom.png" alt="Zoom" />
          </div>
          <a href="../equip100-courses/virtual-learning/zoom.html">Enroll</a>
        </div>
        <div class="listed-courses">
          <p class="course-header">Google Meet</p>
          <p class="course-short-description">Master Virtual Connections with our Google Meet Tutorial Course!</p>
          <div class="course-image">
            <img src="../img/google-meet.png" alt="Google meet" />
          </div>
          <a href="../equip100-courses/virtual-learning/google-meet.html">Enroll</a>
        </div>
        <div class="listed-courses">
            <p class="course-header">Amazon Chime</p>
            <p class="course-short-description">Conquer Communication with Amazon Chime</p>
            <div class="course-image">
              <img src="../img/amazon-chime.png" alt="Amazon Chime" />
            </div>
            <a href="../equip100-courses/virtual-learning/amazon-chime.html">Enroll</a>
        </div>  
      </div>
    </div>
    </div>
