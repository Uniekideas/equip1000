...
<head>
    ...
    <title>AI Tools - EQUIP1000</title>
    ...
    <div class="content mobile-course-content">
      ...
      <div class="microsoft-container">
        ...
        <div class="microsoft-office-suite-description">
          <p><span class="one">Unleashing the Power of AI:
          <br /></span>
          <span class="two">A Teacher&#039;s Guide to Revolutionary Tools<br /></span>
          <span class="three">Imagine a classroom where personalized learning, instant feedback, and engaging lesson plans are the norm. This isn&#039;t science fiction;it&#039;s the reality within reach thanks to AI tools for educators.<br /></span>
          </p>
        </div>
        <div class="microsoft-office-suite-image">
          <img src="../img/ai-tools.png" alt="AI Tool"/>
        </div>
        <div class="course-description">
          <p class="desc">This comprehensive tutorial course will equip you with the knowledge and skills to harness the power of AI and transform your teaching practice.</p>
          <p class="course-duration">Course Duration: 56 Hrs</p>
        </div>
        ...
        <div class="listed-courses top-course">
          <p class="course-header">Quillionz</p>
          <p class="course-short-description">Tired of writer's block when crafting engaging questions? Quillionz is here to save the day!</p>
          <div class="course-image">
            <img src="../img/quillionz.png" alt="Quillionz" />
          </div>
          <a href="../equip100-courses/ai-tools/quillionz.html">Enroll</a>
        </div>
        <div class="listed-courses">
          <p class="course-header">Grammarly</p>
          <p class="course-short-description">Your Guide to Writing Confidence</p>
          <div class="course-image">
            <img src="../img/grammarly.png" alt="Grammarly" />
          </div>
          <a href="../equip100-courses/ai-tools/grammarly.html">Enroll</a>
        </div>
        <div class="listed-courses">
          <p class="course-header">Google Classroom</p>
          <p class="course-short-description">Conquer the Classroom</p>
          <div class="course-image">
            <img src="../img/google-classroom.png" alt="Google classroom" />
          </div>
          <a href="../equip100-courses/ai-tools/google-classroom.html">Enroll</a>
        </div>
        <div class="listed-courses">
            <p class="course-header">Chat GPT</p>
            <p class="course-short-description">Unleash the Power of ChatGPT</p>
            <div class="course-image">
              <img src="../img/chat-gpt.png" alt="Chat GPT" />
            </div>
            <a href="../equip100-courses/ai-tools/chat-gpt.html">Enroll</a>
        </div>  
      </div>
    </div>
    </div>
