...
<head>
    ...
    <title>Certificates - EQUIP1000</title>
    ...
    <link rel="stylesheet" href="../css/lms/certificate.css">
...
<body>
  ...
  <!-- End of notification pop up -->
    ...
    <div class="sidebar-active">
        ...
        <a class="side-link active" href="../certificates/certificates.html">
        ...
        <a class="side-link logout" href="../lms.html" onclick="confirmLogout()">
    ...
    <div class="content cert-main">
      <div class="main-screen">
        <div class="categories-container cert-container">
          <div class="certificates-section-header">
            <p class="welcome-text">Hi, Prince!</p>
            <p class="welcome-subtext">Celebrate Your Achievements!</p>
            <p class="subtext">This space is dedicated to showcasing your hard work, dedication, and accomplishments as you navigate the exciting world of technology and social media.</p>
          </div>
          <div class="certificates-container">
            <div class="box">
              <img src="../img/img-preview-cert.png" alt="certificate">
              <a href="#">Download</a>
            </div>
            <div class="box">
              <img src="../img/cert-2.png" alt="certificate">
              <a href="#">Download</a>
            </div>
            <div class="box">
              <img src="../img/cert-3.png" alt="certificate">
              <a href="#">Download</a>
            </div>
            <div class="box">
              <img src="../img/cert-4.png" alt="certificate">
              <a href="#">Download</a>
            </div>
            <div class="box">
              <img src="../img/cert-5.png" alt="certificate">
              <a href="#">Download</a>
            </div>
          </div>
          <div class="preview-pane">
            <p class="preview-title">PREVIEW PANE</p>
            <img src="../img/img-preview-cert.png" alt="certificate">
            <div class="cert-download-wrapper">
